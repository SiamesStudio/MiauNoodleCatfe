...
////
        ...
        //var fondoNaranja = this.add.image(config.width/2, config.height/2, 'bg_dawn').setBlendMode(Phaser.BlendModes.MULTIPLY).setAlpha(0);
        //var fondoAzul = this.add.image(config.width/2, config.height/2, 'bg_night').setTint(0xffffff).setAlpha(0).setBlendMode(Phaser.BlendModes.MULTIPLY).setAlpha(1);
        ...
        //var backgroundStreet = this.add.image(config.width/2, config.height/2, 'background_gif')
